      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          <div className="flex flex-col justify-center">
            <h3 className="text-2xl font-bold text-secondary-foreground">Contact Information</h3>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-4">
                ...
                <a href="mailto:hello@sukasuka.setudio" className="text-muted-foreground hover:text-primary transition-colors">
